...
const ProductListPage = lazy(() => import("pages/ProductList/ui/ProductListPage"));
const PartnersAddressMapPage = lazy(() => import("pages/PartnersAddressMap/ui/PartnersAddressMapPage"));
...
export const Router = () => {
    return (
        <Routes>
            ...
            <Route path="/product-list" element={withLazyLoadWrapper(<ProductListPage />)} />
            <Route path="/partners">
                <Route index={true} element={withLazyLoadWrapper(<PartnersPage />)} />
                <Route path="address" element={withLazyLoadWrapper(<PartnersAddressMapPage />)} />
            </Route>
