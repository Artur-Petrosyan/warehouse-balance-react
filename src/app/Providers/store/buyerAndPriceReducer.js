...
export const asyncSetBuyerAndPriceData = createAsyncThunk(
  "buyerData/asyncSetBuyerAndPriceData",
  async () => {
    try {
      ...
      const buyerTotal = arrayFromHTMLCollectionPartnersNameAndPrice(
        buyerTotalPrice,
        "TotalPrice",
      );
      const buyerName = arrayFromHTMLCollectionPartnersNameAndPrice(
        XMLDataBuyer,
        "Taxpayer",
        "Name",
      );
...
export const { removeBuyerAndPriceData, setBuyerAndPriceData } =
  buyerAndPriceSlice.actions;
