...
const PartnersPagePure = ({
    ...
    return (
        <div>
            {alertState ? (
                <Alert message="Warning" description="There is not a address" type="warning" showIcon />
            ) : null}
            <InputSearch placeholderText={"Find Partners"} />
            <Table status={status} columns={columns} dataSource={searchQuery ? searchData : data.EXCELData} />
